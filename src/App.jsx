...
function App() {
  const testimonials = [
    { name: "Amanda Souza", text: "Meu pet fez xixi no sofá e achei que teria que jogar fora pelo cheiro. A equipe da Aconchego removeu o odor e as manchas totalmente. Além disso, minha rinite parou de atacar! É saúde e economia real.", img: "/img/AmandaSouza.png" },
    { name: "Carlos Eduardo", text: "Fiquei impressionado com a sujeira que saiu do colchão. O serviço de extração profunda é outro nível, o quarto ficou até mais leve. Atendimento nota 10.", img: "/img/CarlosEduardo.png" },
